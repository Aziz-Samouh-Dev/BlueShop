    ...
    <main class="h-full overflow-y-auto  px-4">
        <div class="container mx-auto grid">
                    ...
                    <div>
                        ...
                        <p class="text-lg font-semibold text-gray-700">
                            ...
                            @foreach ($orders as $order)
                                <?php $totalBalance += $order->total_price; ?>
                            @endforeach
                            $ {{ $totalBalance }}
                        </p>
                    </div>
            ...
            <div class="grid gap-6 mb-8 md:grid-cols-1 xl:grid-cols-3">
                <div class="block col-span-2 items-center py-4">
                    <h2 class="my-6 text-2xl font-semibold text-gray-700 leading-tight">
                        {{ __('Products') }}
                    </h2>
                    <div class="w-full overflow-hidden bg-white shadow-lg ">
                ...
                <div class="block col-span-1 items-center py-4">
                    <h2 class="my-6 text-2xl font-semibold text-gray-700 leading-tight">
                        {{ __('Users') }}
                    </h2>
                            ...
                            <table class="table-auto w-full text-gray-400 bg-gray-50">
                                ...
                                <tbody class="bg-white divide-y ">
                                    ...
                                    @if (count($users->where('role', 'user')) > 0)
                                        @foreach ($users->where('role', 'user')->take(8) as $user)
                                            <tr class="text-gray-700">
                                                <td class="px-4 py-3">
